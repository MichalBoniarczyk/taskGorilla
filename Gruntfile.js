...
module.exports = function (grunt) {
    ...
    var spritesPath = 'src/assets/images/images-sprite/';
    var config = {
            src: 'src',
            tmp: 'tmp',
            build: 'build',
	...
	grunt.initConfig({
		...
		copy: {
			...
			images: {
				...
				src: [
						'logo.gif', 				'favicon.ico',
						'products/product-1.jpg',   'products/product-2.jpg',
						'products/product-3.jpg',	'down-arrow-select.png',
						'search.png'
				],
		...
		sprite: {
			all: {
			    src: [
			    	spritesPath + 'arrow-left.png', 		spritesPath + 'arrow-right.png',
			    	spritesPath + 'color-62b99b.png',		spritesPath + 'color-00979c.png',
			    	spritesPath + 'color-873043.png',		spritesPath + 'color-e86d20.png',
			    	spritesPath + 'color-ff5e64.png',		spritesPath + 'down-arrow.png',
			    	spritesPath + 'facebook.png',			spritesPath + 'instagram.png',
			    	spritesPath + 'mini-bag.png',			spritesPath + 'new.png',
			    	spritesPath + 'remove.png',				spritesPath + 'sale.png',
			    	spritesPath + 'star-empty.png',			spritesPath + 'youtube.png',
			    	spritesPath + 'star-full.png',			spritesPath + 'three-gird.png',
			    	spritesPath + 'two-gird.png',			spritesPath + 'twitter.png',
			    	spritesPath + 'up-arrow.png'		
				],
